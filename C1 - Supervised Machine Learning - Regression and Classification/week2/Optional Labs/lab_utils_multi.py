...
def plot_cost_i_w(X, y, hist):
    ...
    _extracted_from_plot_cost_i_w_12(ax, 0, "Cost vs Iteration", "iteration")
    ax[1].plot(wr, cst)
    _extracted_from_plot_cost_i_w_12(ax, 1, "Cost vs w[0]", "w[0]")
    ax[1].plot(ws[:, 0], hist["cost"])
    plt.show()


# TODO Rename this here and in `plot_cost_i_w`
def _extracted_from_plot_cost_i_w_12(ax, arg1, arg2, arg3):
    ax[arg1].set_title(arg2)
    ax[arg1].set_xlabel(arg3)
    ax[arg1].set_ylabel("Cost")
